...
Action | Keys 
--- | :-:
**Switch** to virtual desktop **1, 2, etc.**<br>*(you can also use the Numpad)*|<kbd>Win</kbd> + <kbd>1</kbd><br><kbd>Win</kbd> + <kbd>2</kbd><br>...<br><kbd>Win</kbd> + <kbd>9</kbd>
**Switch back** to the last desktop used|<kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>Tab</kbd>
**Switch** to the virtual desktop on the **left**<br>*(auto-cycles from the first to the last desktop)*|<kbd>Ctrl</kbd> + <kbd>Win</kbd> + <kbd>H</kbd>
**Switch** to the virtual desktop on the **right**<br>*(auto-cycles from the last to the first desktop)*|<kbd>Ctrl</kbd> + <kbd>Win</kbd> + <kbd>L</kbd>
**Create** a new virtual desktop|**<kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>C</kbd>**
**Delete** the current virtual desktop|<kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>D</kbd>
**Move** the current window to another desktop, then switch to it<br>*Keys <kbd>Q</kbd>, <kbd>W</kbd>, etc. correspond to **1st, 2nd, etc.** desktops*|<kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>1</kbd><br><kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>2</kbd><br>...<br><kbd>Win</kbd> +  <kbd>Shift</kbd> + <kbd>0</kbd>
**Move** the current window to the previous or the next desktop, then switch to it|<kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>H</kbd><br><kbd>Win</kbd> + <kbd>Shift</kbd> + <kbd>L</kbd>

Note, <kbd>Win</kbd> continues to function normally even when it is used as a modifier. [But you can make the button do more useful things such as open overview, or disable it altogether](https://github.com/pmb6tz/windows-desktop-switcher/issues/67).

If you'd like, you can [enable the alternate configuration](https://github.com/pmb6tz/windows-desktop-switcher/issues/44), to use <kbd>Ctrl</kbd> + <kbd>Alt</kbd> as hotkey combination keys instead of <kbd>Win</kbd> (e.g. use <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>1</kbd> to switch to the Desktop 1, just as you would use <kbd>Win</kbd> + <kbd>1</kbd>).
...
`Win & n::switchDesktopToRight()` | **Hotkey:** <kbd>Capslock</kbd> + <kbd>N</kbd><br>**Action:** Switch to the desktop on the right<br>*(& is necessary when using a non-modifier key such as Capslock)*
`!n::switchDesktopToRight()` | **Hotkey:** <kbd>Alt</kbd> + <kbd>N</kbd><br>**Action:** Switch to the desktop on the right
